...
urlpatterns = [
    ...
    path('arr/fossils/<int:fossil_id>/',views.have_fossil,name='have_fossil'),
    path('arr/songs/',views.all_songs,name='all_songs'),
    path('arr/songs/<int:song_id>/',views.have_song,name='have_song'),
